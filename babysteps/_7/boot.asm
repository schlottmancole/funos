...
; WE ARE NOW IN PROTECTED MODE
	...
	mov bx, 0x08 ;put descriptor 1 into DS (set DS[15:3] = 13'h00001)
	mov ds, bx
...
; WE ARE IN REAL MODE AGAIN
	...
	mov bx, 0x0f01 ;data to write to 0x0b8000
	mov eax, 0x0b8000 ;put 32-bit offset into eax
	mov word [ds:eax], bx ;write to 32-bit offset
